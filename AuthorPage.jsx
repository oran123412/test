    ...
    <>
      <div className="container-page">
        ...
        <Swiper
          ...
          slidesPerView={window.innerWidth > 768 ? 3 : 1} // 3 slides per view on wide screens, 1 on narrow screens
            ...
            <SwiperSlide key={video.id.videoId}>
              <div style={{ textAlign: "center" }}>
                <img
                  ...
                  alt={video.snippet.title.replace(/;/g, "")} // Remove semicolons from the alt text as well
                ...
                >
                  ...
                  {/* Removing semicolons from the title */}
                </a>
              </div>
            </SwiperSlide>
          ))}
